    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.pet_bathe_button_inner:
                if (pet.getIsBathed()) {
                    Toast.makeText(this, pet.getName() + " has been recently bathed", Toast.LENGTH_SHORT);
                } else {
                    pet.bathe();
                }
                break;
            ...
            case R.id.pet_color_button_inner:
                if (pet.getMoodLevel() >= 2) {
                    ...
                    Toast.makeText(this, pet.getName() + " needs mood level of 2 or higher to change color",
